...
import { createVault, decryptEnv, encryptEnv, rewrapWithPassword, unlockWithPassword, unlockWithRecoveryKey, } from "./vault.js";
...
test("env encrypt/decrypt round-trip", async () => {
    ...
    const decrypted = await decryptEnv(masterKey, encrypted.nonce, encrypted.ciphertext);
