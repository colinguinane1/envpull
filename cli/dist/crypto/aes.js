...
export async function aesGcmDecrypt(key, nonce, ciphertext) {
...
export function packNonceAndCiphertext(nonce, ciphertext) {
    return Buffer.concat([nonce, ciphertext]).toString("base64");
}
export function unpackNonceAndCiphertext(packed) {
